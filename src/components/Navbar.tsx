    ...
    <header className="fixed top-0 inset-x-0 z-50 backdrop-blur-md bg-background/70 border-b border-border/60">
      <div className="max-w-6xl mx-auto px-6 h-24 md:h-28 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-6 text-xs text-muted-foreground">
          <Link href="/#kundenprojekte" className="hover:text-ink transition">Projekte</Link>
      ...
      {open && (
        <div className="md:hidden border-t border-border/60 bg-background/95 backdrop-blur-md">
          <nav className="flex flex-col px-6 py-4 gap-1 text-sm text-muted-foreground">
            <Link href="/#kundenprojekte" onClick={close} className="py-2.5 hover:text-ink transition">Projekte</Link>
            ...
            <Link href="/#schreib-mir" onClick={close} className="py-2.5 hover:text-ink transition">Kontakt</Link>
            <Link
              href="/webseiten-vorschau"
              onClick={close}
