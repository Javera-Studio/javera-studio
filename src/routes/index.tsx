...
function FeaturedLuxe() {
  ...
  const mockups: { src?: string; alt: string; span: string; aspect: string; label: string }[] = [
    { src: luxe-visitenkarten, alt: "Visitenkarten Mockup", span: "md:col-span-7", aspect: "aspect-[4/3]", label: "Visitenkarten" },
    { src: luxe-gutschein, alt: "Gutschein Mockup", span: "md:col-span-5", aspect: "aspect-[4/5]", label: "Gutscheine" },
    { src: luxe-social-1, alt: "Social Media Template 1", span: "md:col-span-4", aspect: "aspect-square", label: "Social Post" },
    { src: luxe-social-2, alt: "Social Media Template 2", span: "md:col-span-4", aspect: "aspect-square", label: "Social Post" },
    { src: luxe-social-3, alt: "Social Media Template 3", span: "md:col-span-4", aspect: "aspect-square", label: "Social Post" },
    { src: luxe-preisliste, alt: "Preisliste Mockup", span: "md:col-span-12", aspect: "aspect-[16/9]", label: "Preisliste" },
  ];
