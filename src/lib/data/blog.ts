...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: [
      ...
      { type: "paragraph", text: "Bei JAVERA Studio kostet die Starter Website einmalig ab 500 €, die Premium Website (bis zu 3 Seiten) ab 900 € – je nach Umfang. Zusatzseiten werden nach Aufwand kalkuliert. Dazu kommen ca. 15 € pro Jahr für Domain & Hosting. Verglichen mit dem Umsatz einer einzigen Neukundin pro Monat rechnet sich das sehr schnell." },
