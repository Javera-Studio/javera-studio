...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: [
      ...
      { type: "paragraph", text: "Einen ausführlichen Preisvergleich für alle Beauty-Branchen findest du in unserem Artikel zu den Website-Kosten für Beauty-Studios." },
