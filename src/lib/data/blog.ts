...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: [
      ...
      { type: "paragraph", text: "Bei JAVERA Studio kostet die Starter Website einmalig ab 500 €, die Premium Website (bis zu 3 Seiten) ab 900 € – je nach Umfang. Zusatzseiten werden nach Aufwand kalkuliert. Dazu kommen als Richtwert ab dem 2. Jahr ca. 25 € pro Jahr für Domain & Hosting (ca. 55 € pro Jahr mit eigener E-Mail-Adresse), abhängig vom Anbieter. Verglichen mit dem Umsatz einer einzigen Neukundin pro Monat rechnet sich das sehr schnell." },
    ...
    faq: [
      ...
      { question: "Was kostet eine Website für ein Nagelstudio?", answer: "Eine Starter Website kostet bei JAVERA Studio ab 500 €, eine Premium Website mit bis zu 3 Seiten ab 900 € – abhängig vom Umfang. Details findest du im Artikel „Was kostet eine Website für ein Beauty-Studio?“." },
  ...
  },
  {
    ...
    faq: [
      ...
      { question: "Kann ich KI-Bilder für mein Beauty-Studio verwenden?", answer: "Grundsätzlich ja. KI-generierte Bilder sollten jedoch transparent und markenkonform eingesetzt werden. Mit den Transparenzpflichten des EU AI Acts, die ab 2. August 2026 gelten, müssen insbesondere bestimmte KI-generierte oder manipulierte Inhalte gekennzeichnet werden, wenn sie täuschend echt wirken können. Unabhängig davon solltest du keine unrealistischen Behandlungsergebnisse vortäuschen. Gerade bei Vorher-Nachher-Bildern und Ergebnisdarstellungen sind echte Arbeiten aus deinem Studio die bessere Wahl." },
