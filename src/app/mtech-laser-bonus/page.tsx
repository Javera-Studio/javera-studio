      ...
      <section className="relative overflow-hidden pt-14 pb-20 md:pt-24 md:pb-32">
        ...
        <div className="relative max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="hero-subtitle mt-6 text-lg text-muted-foreground leading-relaxed">
            Sie haben gerade einen wichtigen Schritt für Ihr Beauty-Business gemacht.
          </p>
          <p className="hero-subtitle mt-4 text-lg text-muted-foreground leading-relaxed">
            Als Kundin von MTech Laser erhalten Sie deshalb exklusiv eine
          </p>
          <p className="hero-subtitle mt-2 text-lg font-semibold text-primary">
        ...
        <div className="max-w-[65.52rem] mx-auto px-6 text-center">
          ...
          <div className="mt-8 space-y-5 text-muted-foreground leading-relaxed text-[1.05rem] text-center">
            ...
            <p className="reveal reveal-stagger-3">
              Mit dieser Analyse erhalten Sie von JAVERA Studio einen objektiven Blick auf Ihre Online-Präsenz sowie konkrete Handlungsempfehlungen, um Ihr Studio professioneller zu präsentieren und noch mehr potenzielle Kundinnen zu erreichen.
            </p>
          </div>
        </div>
      </section>
