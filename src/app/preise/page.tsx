...
export default function PreisePage() {
  // In beiden Website-Paketen enthalten – einmal zusammengefasst statt in beiden
  // Karten wortgleich wiederholt (u. a. SEO-Grundoptimierung, Buchungsintegration,
  // Barrierefreiheits-Grundlagen).
  const websiteSharedFeatures: FeatureItem[] = [
    { included: true, title: "Mobil optimierte Darstellung", desc: "Perfekte Darstellung auf Smartphone, Tablet und Desktop." },
    { included: true, title: "Kontaktformular", desc: "Interessentinnen können dich direkt über die Website kontaktieren." },
    { included: true, title: "Integration bestehender Buchungsmöglichkeiten", desc: "Verlinkung zu Planity, Treatwell, Beautinda oder deinem Buchungssystem." },
    { included: true, title: "SEO-Grundoptimierung", desc: "Damit deine Website von Google besser gefunden werden kann." },
    { included: true, title: "Professionelle Texte", desc: "Texte werden auf Basis deiner Informationen erstellt." },
    {
      included: true,
      title: "Barrierefreiheit im Blick",
      desc: "Ausreichende Farbkontraste, sichtbare Fokuszustände und mit den Formularfeldern verknüpfte Fehlermeldungen, orientiert an den WCAG-Richtlinien.",
    },
  ];

  const starterFeatures: FeatureItem[] = [
    { included: true, title: "Individuelles Design statt Standardvorlage", desc: "Passend zu deinem Studio, deinen Farben und deiner Marke." },
  ...
  return (
    <main className="bg-background text-ink min-h-screen">
      ...
      {/* WEBSEITEN – Hauptleistung, optisch priorisiert direkt nach dem Intro */}
      <section className="py-14 md:py-20 bg-cream">
        <div className="max-w-5xl mx-auto px-6">
          <p id="website" className="text-[11px] font-semibold uppercase tracking-[0.15em] text-muted-foreground mb-5 scroll-mt-24">Website-Pakete</p>

          <div className="bg-background rounded-[2rem] p-6 md:p-8 mb-5">
            <SectionLabel>In beiden Website-Paketen enthalten</SectionLabel>
            <div className="grid sm:grid-cols-2 gap-x-8 gap-y-0">
              {websiteSharedFeatures.map((f) => <FeatureRow key={f.title} {...f} />)}
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-5 items-stretch">
            ...
            <div className="bg-background rounded-[2rem] p-8 flex flex-col">
              ...
              <p className="mt-3 text-sm text-ink/80">Passt zu dir, wenn du dein Studio und deine wichtigsten Leistungen kompakt auf einer Seite vorstellen möchtest.</p>
              <div className="py-5">
              ...
              <SectionLabel>Zusätzlich in diesem Paket</SectionLabel>
              {starterFeatures.map((f) => <FeatureRow key={f.title} {...f} />)}
              <div className="mt-auto">
                <SectionLabel>Support</SectionLabel>
                {starterSupport.map((f) => <FeatureRow key={f.title} {...f} />)}
                <div className="pt-6">
                  <Link
                    href="/webseiten-vorschau"
            ...
            <div className="relative bg-[#E5DCD5]/50 rounded-[2rem] p-8 flex flex-col">
              ...
              <p className="mt-3 text-sm text-ink/80">Passt zu dir, wenn du deine Leistungen und dein Studio auf mehreren Seiten ausführlicher vorstellen möchtest.</p>
              <div className="py-5">
                <div className="text-3xl font-bold text-ink leading-none">
              ...
              <div className="h-px bg-ink/10 mb-5" />
              <SectionLabel>Zusätzlich in diesem Paket</SectionLabel>
              {premiumFeatures.map((f) => <FeatureRow key={f.title} {...f} />)}
      ...
      <section className="py-14 md:py-20 bg-cream">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <p className="text-sm text-muted-foreground max-w-2xl mb-6 leading-relaxed">
            Domain, Hosting und gegebenenfalls E-Mail laufen extern über den jeweiligen Anbieter auf deinen Namen. Nach dem Launch ist eine kostenlose Nachbetreuung enthalten – {pricing.websites.starter.supportTage} Tage bei der Starter Website, {pricing.websites.premium.supportTage} Tage bei der Premium Website. Ein Wartungsabo bei Javera Studio ist danach nicht verpflichtend: Du kannst bei Bedarf ein Wartungspaket buchen oder eine einzelne Änderung beauftragen.
          </p>
          <div className="grid sm:grid-cols-3 gap-5 items-stretch">
            ...
            <div id="wartung" className="bg-background rounded-[2rem] p-6 flex flex-col scroll-mt-24">
              ...
              <p className="text-xs text-muted-foreground mt-1 italic">optional, kein verpflichtendes Abo</p>
      ...
      {/* DIGITALE PRÄSENZ: Google Business Profil + Social-Media-Vorlagen */}
      <section id="digitale-praesenz" className="py-14 md:py-20 bg-peach-muted scroll-mt-24">
        <div className="max-w-5xl mx-auto px-6">
          <p className="text-[11px] font-semibold uppercase tracking-[0.15em] text-muted-foreground mb-5">Digitale Präsenz</p>
          <p className="text-sm text-muted-foreground max-w-2xl mb-6 leading-relaxed">
            Eine gute Website wirkt am stärksten, wenn auch die übrigen digitalen Kontaktpunkte ein stimmiges und professionelles Bild vermitteln.
          </p>

          {/* Google Business Profil */}
          <div id="google-business" className="bg-background rounded-[2rem] p-8 md:p-10 scroll-mt-24">
          ...
          <div id="social" className="mt-5 bg-background rounded-[2rem] overflow-hidden scroll-mt-24">
            <div className="px-7 pt-7 pb-2">
              <p className="text-lg font-semibold text-ink mb-1">Social-Media-Vorlagen</p>
              <p className="text-sm text-muted-foreground max-w-lg leading-relaxed">
                Ich gestalte Vorlagen und visuelle Grundlagen für deinen Social-Media-Auftritt – keine laufende Content-Planung oder Kanalbetreuung.
              </p>
            </div>
      ...
      {/* PRINTDESIGN */}
      <section id="grafik-print" className="py-14 md:py-20 bg-cream scroll-mt-24">
        <div className="max-w-5xl mx-auto px-6">
          <p className="text-[11px] font-semibold uppercase tracking-[0.15em] text-muted-foreground mb-5">Printdesign</p>
      ...
      {/* ERGÄNZENDE KOMBIPAKETE */}
      <section id="pakete" className="py-14 md:py-20 bg-peach-muted scroll-mt-24">
        <div className="max-w-5xl mx-auto px-6">
          <p className="text-[11px] font-semibold uppercase tracking-[0.15em] text-muted-foreground mb-5">Ergänzende Kombipakete</p>
          ...
          <div className="mt-4 bg-[#E5DCD5]/60 rounded-[1.75rem] px-6 py-4 text-center">
            <p className="text-sm text-ink">
              ...
              <strong>Website-Kunden erhalten {pricing.zahlung.websiteRabattProzent} % Rabatt</strong>{" "}auf alle Design-Leistungen (Printdesign &amp; Social Media).
            </p>
          </div>
      ...
      {/* ANALYSEN & CHECKS FÜR BESTEHENDE ONLINE-AUFTRITTE */}
      <section className="py-14 md:py-20 bg-cream">
        <div className="max-w-5xl mx-auto px-6">
          <p id="analyse" className="text-[11px] font-semibold uppercase tracking-[0.15em] text-muted-foreground mb-5 scroll-mt-24">Analysen &amp; Checks für bestehende Online-Auftritte</p>
